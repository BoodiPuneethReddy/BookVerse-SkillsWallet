...
import { Mail, Lock, Eye, EyeOff, User, Phone, ShieldAlert, ArrowLeft } from 'lucide-react';
      ...
      <div className="auth-split-wrapper">
        ...
        <div className="auth-art-column admin-art-bg">
          ...
          <div className="art-text-block">
            ...
            <p>Setup new administrator clearance. Moderation parameters, vendor settings, and platform database tools are strictly restricted.</p>
          </div>
        </div>
        ...
        <div className="auth-form-column">
          ...
          >
            <div className="form-card-header">
              <h2>Admin Signup</h2>
              <p>Setup a new administrator profile for platform clearance.</p>
            </div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-group-icon-input">
                <label htmlFor="phone">Phone Contact (Optional)</label>
                <div className="input-icon-group-wrapper">
              ...
              <motion.button 
                ...
                whileTap={{ scale: 0.98 }}
              >
                {loading ? <div className="btn-spinner"></div> : 'Register Admin'}
              </motion.button>
            </form>

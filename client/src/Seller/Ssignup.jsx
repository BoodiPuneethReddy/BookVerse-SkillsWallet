...
import { Mail, Lock, Eye, EyeOff, User, Phone, MapPin, Store, ArrowLeft } from 'lucide-react';
  ...
  return (
    <div className="auth-full-screen font-poppins">
      ...
      <div className="auth-split-wrapper">
        ...
        <div className="auth-art-column seller-art-bg">
          <div className="art-overlay-grid"></div>
          <div className="art-text-block">
            <Store className="art-brand-logo" />
            <h2>Open Your Shop</h2>
            <p>Publish your inventory, receive order details, manage delivery addresses, and interact with a premium audience of local readers online.</p>
          </div>
        </div>
        ...
        <div className="auth-form-column">
          ...
          >
            <div className="form-card-header">
              <h2>Seller Signup</h2>
              <p>Register your vendor details to open your online bookstore shop.</p>
            </div>
            ...
            <form onSubmit={handleSubmit}>
              <div className="form-grid-two-cols">
                ...
                <div className="form-group-icon-input">
                  ...
                  <div className="input-icon-group-wrapper">
                    <Store className="input-field-icon" />
                    <input
                      type="text"
                      id="shopName"
                      name="shopName"
                      ...
                      onChange={handleChange}
                      placeholder="e.g. Reader's Choice"
                      required
                    />
                  </div>
                </div>
              ...
              <motion.button 
                type="submit" 
                className="btn btn-primary btn-block btn-auth-submit btn-seller-theme"
                disabled={loading}
                whileTap={{ scale: 0.98 }}
              >
                {loading ? <div className="btn-spinner"></div> : 'Register Store'}
              </motion.button>
            </form>

            <p className="auth-card-footer-text">
              Already have a shop? <Link to="/seller/login">Log in here</Link>
            </p>
          </motion.div>
        </div>
      </div>

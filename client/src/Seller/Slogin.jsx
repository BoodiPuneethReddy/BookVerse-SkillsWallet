...
const Slogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.data.success) {
        toast.success(res.data.message || 'Logged in successfully as Seller');
      ...
      <div className="auth-split-wrapper">
        ...
        <div className="auth-art-column seller-art-bg">
          ...
          <div className="art-text-block">
            ...
            <h2>Partner with BookVerse</h2>
            <p>List your bookstore catalog online. Reach thousands of local readers, manage orders instantly, and grow your local business with our SaaS tools.</p>
          </div>
        </div>
        ...
        <div className="auth-form-column">
          ...
          >
            <div className="form-card-header">
              <h2>Seller Login</h2>
              <p>Welcome back, partner! Enter your shop email to log in.</p>
            </div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <motion.button 
                ...
                whileTap={{ scale: 0.98 }}
              >
                {loading ? <div className="btn-spinner"></div> : 'Log In to Shop'}
              </motion.button>
            </form>

            <p className="auth-card-footer-text">
              New to BookVerse? <Link to="/seller/signup">Create seller shop</Link>
            </p>
          </motion.div>
        </div>
      </div>

  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.data.success) {
        ...
        if (redirect === 'books') {
          navigate(category ? `/user/books?category=${category}` : '/user/books');
        } else {
          navigate('/user/home');
        }
      }
      ...
      <div className="auth-split-wrapper">
        ...
        <div className="auth-art-column user-art-bg">
          ...
          <div className="art-text-block">
            ...
            <p>Step back into your sanctuary of knowledge. Explore customized recommendations and local collections built just for you.</p>
          </div>
        </div>
        ...
        <div className="auth-form-column">
          ...
          >
            ...
            <p className="auth-card-footer-text">
              Don't have an account? <Link to="/user/signup">Sign up now</Link>
            </p>
          </motion.div>
        </div>
      </div>
